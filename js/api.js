...
async function fetchFinnhubMetrics(ticker) {
  ...
  try {
    ...
    // REAL financial metrics from Finnhub - NO random numbers
    return {
...
async function fetchPriceData(ticker) {
  ...
  try {
    ...
    return {
      ...
      hasRealMetrics: false  // Yahoo doesn't provide detailed metrics
    };
  } catch (error) {
